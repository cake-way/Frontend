...
const CakePick = () => {
  return (
    <section className="pt-8 pl-5  mb-7 ">
      ...
      {/* 슬라이드 섹션 */}
      <Swiper spaceBetween={8} slidesPerView={1.2} className="w-full h-auto ">
        {/* 첫 번째 슬라이드 */}
        <SwiperSlide>
          <div className="z-50 bg-gradient-to-t from-[rgba(255,251,251,0)] to-[rgba(15,15,15,0.58)] bg-blend-multiply mix-blend-multiply relative w-full h-auto aspect-[270/373] object-cover">
            <img
